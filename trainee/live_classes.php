...
// Get classes for registered units
$classes = [];
        ...
        <div class="container">
            <div class="card">
                ...
                <div style="margin-bottom: 1.5rem;">
                    <input type="text" class="form-control" placeholder="Search classes by title, unit, or program...">
                </div>
                
                <div class="tabs">
                    <div class="tab-buttons">
                        <button class="tab-button active" data-tab="upcoming">Upcoming Classes (<?php echo count($upcomingClasses); ?>)</button>
                        <button class="tab-button" data-tab="past">Past Classes (<?php echo count($pastClasses); ?>)</button>
                        <button class="tab-button" data-tab="all">All Classes (<?php echo count($classes); ?>)</button>
                    </div>
                                ...
                                <div class="grid">
                                    ...
                                    <div class="class-card">
                                        ...
                                        <div class="class-card-content">
                                            <p><strong>Unit:</strong> <?php echo htmlspecialchars($class['unit_name'] ?? 'N/A'); ?></p>
                                            ...
                                            <div style="margin-top: 1rem;">
                                                <?php if (strtotime($class['start_time']) > time()): ?>
                                                    <a href="class.php?id=<?php echo $class['id']; ?>" class="btn btn-block">Join Class</a>
                                                <?php else: ?>
                                                    <a href="class.php?id=<?php echo $class['id']; ?>" class="btn btn-block">View Recording</a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
